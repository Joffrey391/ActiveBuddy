...
const CommentForm: FC<Props> = ({title, busy = false, onSubmit}): JSX.Element => {
    ...
    return (
        <div>
            {title? <h1 className='text-xl text-primary-dark dark:text-primary font-semibold py-3'>{title}</h1>: null}
            <EditorContent 
